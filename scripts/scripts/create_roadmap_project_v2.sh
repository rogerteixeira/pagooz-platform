...
"## Objective
Provision pagooz_d1_staging and pagooz_d1_prod and apply 0001/0002.
...
create_issue \
"Task: Add wrangler configs for core/ledger/notify" \
"## Objective
Create staging/prod TOML configs with correct bindings.

## Acceptance
- core/ledger/notify deploy commands work
" \
"type:task,area:infra,prio:P0" \
"M1 — Infra + Environments"
...
add_issue_with_fields "Task: Add wrangler configs for core/ledger/notify" "P0" "Infra" "M1"
