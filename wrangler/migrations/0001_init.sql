...
CREATE TABLE IF NOT EXISTS api_keys (
  ...
  mode TEXT NOT NULL CHECK (mode IN ('sandbox','live')),
  environment TEXT NOT NULL DEFAULT 'prod' CHECK (environment IN ('local','dev','staging','prod')),
...
-- Each consumer (ledger-worker, notification-worker, timeline-builder) records processed events.
